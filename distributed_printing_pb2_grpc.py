...
class MutualExclusionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReleaseAccess = channel.unary_unary(
                ...
                request_serializer=distributed__printing__pb2.ReleaseMessage.SerializeToString,
                response_deserializer=distributed__printing__pb2.ReleaseResponse.FromString,
                _registered_method=True)
...
def add_MutualExclusionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReleaseAccess': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=distributed__printing__pb2.ReleaseMessage.FromString,
                    response_serializer=distributed__printing__pb2.ReleaseResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class MutualExclusionService(object):
    ...
    def ReleaseAccess(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/distributed_printing.MutualExclusionService/ReleaseAccess',
            distributed__printing__pb2.ReleaseMessage.SerializeToString,
            distributed__printing__pb2.ReleaseResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
